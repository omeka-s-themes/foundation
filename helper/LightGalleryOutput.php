...
class LightGalleryOutput extends AbstractHelper
{
    ...
    {
        $view = $this->getView();
        $view->headScript()->prependFile($view->assetUrl('vendor/lightgallery/lightgallery.min.js'));
        $view->headScript()->appendFile($view->assetUrl('vendor/lightgallery/plugins/thumbnail/lg-thumbnail.min.js'));
        $view->headScript()->appendFile($view->assetUrl('vendor/lightgallery/plugins/zoom/lg-zoom.min.js'));
        $view->headScript()->appendFile($view->assetUrl('vendor/lightgallery/plugins/video/lg-video.min.js'));
        $view->headScript()->appendFile($view->assetUrl('vendor/lightgallery/plugins/hash/lg-hash.min.js'));
        $view->headScript()->appendFile($view->assetUrl('vendor/lightgallery/plugins/rotate/lg-rotate.min.js'));
        $view->headScript()->appendFile($view->assetUrl('js/show.js'));
        $view->headLink()->prependStylesheet($view->assetUrl('vendor/lightgallery/css/lightgallery-bundle.min.css'));
        $escape = $view->plugin('escapeHtml');

        $html = '<ul id="itemfiles">';
